...
static struct sensor_reg Exposure_Plus_Two[] = {
{0x098C, 0xA24F},
{0x0990, 0x0096},	// 150
{SENSOR_TABLE_END, 0x0000}
};

static struct sensor_reg Exposure_Plus_One[] = {
{0x098C, 0xA24F},
{0x0990, 0x0078},	// 120
{SENSOR_TABLE_END, 0x0000}
};

static struct sensor_reg Exposure_Zero[] = {
{0x098C, 0xA24F},
{0x0990, 0x005C},	// 92
{SENSOR_TABLE_END, 0x0000}
};

static struct sensor_reg Exposure_Minus_One[] = {
{0x098C, 0xA24F},
{0x0990, 0x003C},	// 60
{SENSOR_TABLE_END, 0x0000}
};

static struct sensor_reg Exposure_Minus_Two[] = {
{0x098C, 0xA24F},
{0x0990, 0x001E},	// 30
{SENSOR_TABLE_END, 0x0000}
};
