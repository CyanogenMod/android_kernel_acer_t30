...
static const struct tegra_emc_table cardhu_emc_tables_picasso_E2_WIFI_samsung_1gb[] =
{
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
	...
	case BOARD_PICASSO_E2:
		...
		switch(RAM_CODE){
			...
			case 1:
				switch(acer_sku) {
					case BOARD_SKU_WIFI:
						pr_info("%s: WIFI SKU Samsung 1GB memory found\n", __func__);
						tegra_init_emc(cardhu_emc_tables_picasso_E2_WIFI_samsung_1gb,
								ARRAY_SIZE(cardhu_emc_tables_picasso_E2_WIFI_samsung_1gb));
						break;
					case BOARD_SKU_3G:
